...
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@tasseturl'); ?>/nav/css/5309a-2462.css" />
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@tasseturl'); ?>/nav/css/9d871-8047.css">
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@tasseturl'); ?>/nav/css/9acb7-9767.css">
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@tasseturl'); ?>/nav/css/396df-8579.css">
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@tasseturl'); ?>/nav/css/eff9f-4672.css">
...
<div class="cont">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="http://guozhivip.com/pod/" style="color: #fff" title="新媒体运营资源导航">
            <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/e0a62-6012.png" width="30" height="30" class="d-inline-block align-top" alt="果汁运营" />果汁运营</a>
    ...
    <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6">
        <div class="col">
            <a href="https://mp.weixin.qq.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/d7409-3762.ico" class="ico">微信公众号</a></div>
        <div class="col">
            <a href="https://mp.toutiao.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/2716d-9109.ico" class="ico">头条号</a></div>
        <div class="col">
            <a href="https://baijiahao.baidu.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/ee22e-9309.ico" class="ico">百家号</a></div>
        <div class="col">
            <a href="https://om.qq.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/9e00e-6296.ico" class="ico">企鹅号</a></div>
        <div class="col">
            <a href="https://mp.sohu.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/7633c-1785.ico" class="ico">搜狐号</a></div>
        <div class="col">
            <a href="https://mp.163.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/d8511-4496.ico" class="ico">网易号</a></div>
        <div class="col">
            <a href="https://creator.douyin.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/79a16-1506.png" class="ico">抖音创作平台</a></div>
        <div class="col">
            <a href="https://cp.kuaishou.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/da722-2516.ico" class="ico">快手创作平台</a></div>
        <div class="col">
            <a href="https://member.bilibili.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/73951-1880.ico" class="ico">B站创作中心</a></div>
        <div class="col">
            <a href="https://studio.ixigua.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/25b46-6565.ico" class="ico">西瓜视频创作平台</a></div>
        <div class="col">
            <a href="https://channels.weixin.qq.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/0c6c0-9717.ico" class="ico">微信视频号助手</a></div>
        <div class="col">
            <a href="https://www.xiaohongshu.com/explore" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/99d1f-6516.ico" class="ico">小红书</a></div>
        <div class="col">
            <a href="https://mp.dayu.com/" target="_blank" title="UC旗下自媒体平台" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/91276-9259.ico" class="ico">大鱼号</a></div>
        <div class="col">
            <a href="https://zhuanlan.zhihu.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/60213-5456.ico" class="ico">知乎专栏</a></div>
        <div class="col">
            <a href="https://mp.yidianzixun.com/" target="_blank" title="一点新闻旗下自媒体平台" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/6376b-6340.ico" class="ico">一点号</a></div>
        <div class="col">
            <a href="https://fhh.ifeng.com/" target="_blank" title="凤凰新闻旗下自媒体平台" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/e13db-9924.ico" class="ico">大风号</a></div>
    </div>
    <h5 class="tit" id="rd">
        <b>
            ...
            <li>
                <p>
                    ...
                    <a href="https://space.bilibili.com/306508238" target="_blank" title="站长B站">
                        <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/543c0-3989.png" class="ico" alt="B站" /></a>&nbsp;&nbsp;&nbsp;
                    <a href="https://docs.qq.com/doc/DQXNORkRMT3dRcGlz" target="_blank" title="微信公众号：果汁指南">
                        <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/0eb67-1752.png" class="ico" alt="微信公众号" /></a>&nbsp;&nbsp;&nbsp;
                    <a href="https://www.zhihu.com/people/bo-he-feng-03/activities" target="_blank" title="站长知乎">
                        <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/1403d-7336.png" class="ico" alt="知乎" /></a>&nbsp;&nbsp;&nbsp;
                    <a href="https://weibo.com/guozhivip?is_all=1" target="_blank" title="站长微博">
                        <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/6a5bc-1999.png" class="ico" alt="微博" /></a>&nbsp;&nbsp;&nbsp;
                    <a target="_blank" href="https://jq.qq.com/?_wv=1027&k=5kgTpGb">
                        <img border="0" src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/45296-1865.png" alt="果汁官方交流群" title="果汁交流群：245229401"></a></p>
...
<script type='text/javascript' src='<?= Yii::getAlias('@tasseturl'); ?>/nav/js/79/jquery-1.11.1.min.js'></script>
<script type='text/javascript' src='<?= Yii::getAlias('@tasseturl'); ?>/nav/js/30/popper.min.js'></script>
<script type='text/javascript' src='<?= Yii::getAlias('@tasseturl'); ?>/nav/js/64/bootstrap.min.js'></script>
<script type='text/javascript' src='<?= Yii::getAlias('@tasseturl'); ?>/nav/js/63/back.js'></script>
<script charset="gbk" src="<?= Yii::getAlias('@tasseturl'); ?>/nav/js/opensug.js"></script>
<script type="text/javascript" src="<?= Yii::getAlias('@tasseturl'); ?>/nav/js/47/jquery.anchorscroll.min.js"></script>
