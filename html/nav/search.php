...
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@tasseturl'); ?>/nav/css/9fe01-8889.css" />
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@tasseturl'); ?>/nav/css/8a40b-2218.css" />
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@tasseturl'); ?>/nav/css/7ef48-5329.css" />
<link rel="stylesheet" type="text/css" href="<?= Yii::getAlias('@tasseturl'); ?>/nav/css/5af3c-1908.css" />
...
<div class="mob">
    <div class="mobbc">
        <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/cd01a-1683.png" class="logo" alt="logo" /></div>
    <div class="search">
...
<div class="top"></div>
<div class="logos">
    <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/e3338-6116.gif" title="输入关键词，点击搜索框下方按钮/回车即可搜索"></div>
<div class="jumbotron">
    <div class="container">
    ...
    <div class="row row-cols-3 row-cols-sm-4 row-cols-md-6 row-cols-lg-6">
        <div class="col">
            <a href="https://union-click.jd.com/jdc?e=&p=AyIGZRprFDJWWA1FBCVbV0IUWVALHFRBEwQAQB1AWQkrU1xpcX9RWilwCmByUH0FbANyBCBgOxkOIgJUGloXBhEBXBlrFgMTDlETXBEEEDdlG1olSXwGZRlaFAEbB1wYXxAyEgNdE10UBBcEUBxcFzIVB1wrjLqvxIT2zPS41ZK3VBlrJTIRN2UrWxUyEjcKXwZIMhAGVB9S" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/afb1b-1966.png" class="ico">京东</a></div>
        <div class="col">
            <a href="https://youhui.pinduoduo.com/?pid=10266509_149496685&fromCustomerMall=1&cpsSign=CM_200809_10266509_149496685_db5badf0b2c3286d5afb3827935d6611&duoduo_type=2" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/5f4fc-4859.png" class="ico">拼多多</a></div>
        <div class="col">
            <a href="https://t.vip.com/A8fTmUbytI7" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/31ab8-7510.png" class="ico">唯品会</a></div>
        <div class="col">
            <a href="https://www.taobao.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/405f8-4130.png" class="ico">淘宝</a></div>
        <div class="col">
            <a href="https://www.ctrip.com/?AllianceID=1226872&sid=2892491&ouid=&app=0101F00" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/688a5-6699.png" class="ico">携程</a></div>
        <div class="col">
            <a href="https://weibo.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/8548c-5260.png" class="ico">微博</a></div>
        <div class="col">
            <a href="https://www.qq.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/107f6-8731.png" class="ico">腾讯网</a></div>
        <div class="col">
            <a href="https://www.bilibili.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/90759-7930.png" class="ico">哔哩哔哩</a></div>
        <div class="col">
            <a href="https://www.kuaishou.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/49245-1514.png" class="ico">快手</a></div>
        <div class="col">
            <a href="https://www.douyin.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/0ba33-9685.png" class="ico">抖音</a></div>
        <div class="col">
            <a href="https://www.huya.com/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/196d5-7284.png" class="ico">虎牙</a></div>
        <div class="col">
            <a href="http://guozhivip.com/mvs.html" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/d21ea-1758.png" class="ico">观影追剧</a></div>
        <div class="col">
            <a href="http://guozhivip.com/">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/403a8-5441.png" class="ico">资源大全</a></div>
        <div class="col">
            <a href="http://guozhivip.com/rank/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/bcad7-7063.jpg" class="ico">热门排行榜</a></div>
        <div class="col">
            <a href="http://guozhivip.com/tool/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/002b0-8569.png" class="ico">在线工具</a></div>
        <div class="col">
            <a href="http://guozhivip.com/imgs.html" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/430db-1548.png" class="ico">壁纸美图</a></div>
        <div class="col">
            <a href="http://guozhivip.com/design/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/58739-2277.png" class="ico">设计导航</a></div>
        <div class="col">
            <a href="http://guozhivip.com/lab/" target="_blank">
                <img src="<?= Yii::getAlias('@tasseturl'); ?>/nav/img/791ac-8203.png" class="ico">有点意思</a></div>
    </div>
</div>
<footer>
    <div class="copyright">
...
<script type='text/javascript' src="<?= Yii::getAlias('@tasseturl'); ?>/nav/js/jquery-3.1.0.min.js"></script>
<script type='text/javascript' src='<?= Yii::getAlias('@tasseturl'); ?>/nav/js/80/bootstrap.min.js'></script>
<script type='text/javascript' src="<?= Yii::getAlias('@tasseturl'); ?>/nav/js/jquery-migrate-3.0.0.min.js"></script>
<script type='text/javascript' charset="gbk" src="<?= Yii::getAlias('@tasseturl'); ?>/nav/js/opensug.js"></script>
