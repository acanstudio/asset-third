...
var menuName = new Array("儒家","道家","佛经","法家","百家","兵法","中医","正史","历史","易经","南怀瑾","小雅");
var backImg;
...
function genfooter(){
	 ...
	 document.write("<div class='foot_comm'><div><img src='../../img/shang2.png'></div>");
		...
		document.write("<b>雅说道家群: 122950569；</b>");
		document.write("<b>劝学网历史群: 154204903；</b>");
		document.write("<b>劝学网周易群: 961369711；</b><br>");
...
function genMenu(){
	...
	document.write("<div style='font-size:15px;margin-bottom:10px;line-height:34px;color:#ff0000;'></div>");
    document.writeln("<div  style='border:1px solid black;padding:10px;width:90%;margin:5px auto;font-size:14px;line-height:20px;'><marquee scrollamount=3px   onmouseover='this.stop()'  onMouseOut='this.start()'>《周易雅说》（上经）（第1卦-第30卦的详细解读）视频教程已经在千聊上线，欢迎大家一起学习。微信咨询：13138640099。</marquee></div>");
