...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/rank-min.css?v4.1.4" />
    ...
    <body>
        <div class="top">
            ...
            <div class="logo">
                <img src="images/logo.png" title="掌握权威、热门、优质信息，高效生活！"></div>
            ...
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6">
                ...
                <div class="col">
                    <a href="https://www.tmtpost.com/hot" target="_blank" class="m">钛媒体热文
                        <div class="slogo">
                            <img src="https://www.tmtpost.com/favicon.ico"></div></a>
                </div>
                <div class="col pc">
                    <a href="https://36kr.com/hot-list/catalog" target="_blank" class="g">36Kr资讯热榜
                        <div class="slogo">
                            <img src="images/36kr.png"></div></a>
                </div>
                <div class="col mobs">
                ...
                <div class="col pc">
                    <a href="https://price.pcauto.com.cn/top/r45/" target="_blank" class="m">汽车排行榜
                        <div class="slogo">
                            <img src="images/tpyqc.ico"></div></a>
                </div>
                <div class="col mobs">
        ...
        <div class="erweima">
            <img src="images/pubnumber.jpg" alt="果汁官方公众号" />
            <p>果汁官方公众号</p>
        </div>
        <!-- 抄袭可耻，禁止以任何形式抄袭! -->
