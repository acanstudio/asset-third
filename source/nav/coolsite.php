...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/lab-min.css?v3.1.1">
    ...
    <body>
        ...
        <div class="tn">
            <nav class="navbar navbar-light bg-light navbar-expand-lg">
                <a class="navbar-brand" href="http://guozhivip.com/lab/">
                    <img src="images/logo.png" width="30" height="30" class="d-inline-block align-top" alt="发现优质、实用、有趣站点">果汁实验室</a>
        ...
        <div class="container sub first">
            ...
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6">
                ...
                <div class="card-tit"><img src="images/tz.png"><span class="name" style="color: #F70">重要公告</span></div>
                <div class="card-desc">赶快去看看</div></a>
                </div>-->
                <div class="col">
                    <a href="http://guozhivip.com/mvs.html" class="card-link" target="_blank">
                        <div class="card-tit">
                            <img src="images/gy.png">
                ...
                <div class="card-tit"><img src="images/pd.png"><span class="name">Boredpanda</span></div>
        ...
        <div class="container sub">
            ...
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6">
                ...
                <div class="card-tit"><img src="https://www.52doutu.cn/favicon.ico"><span class="name">表情包制作</span></div>
                <div class="new">Hot</div>
        ...
        <script type='text/javascript' src='css/back.js'></script>
