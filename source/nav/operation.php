...
<html lang="zh">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/pod-min.css?v4.1.3">
    ...
    <body onresize="document.activeElement.scrollIntoView(false);">
        <div class="cont">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="http://guozhivip.com/pod/" style="color: #fff" title="新媒体运营资源导航">
                    <img src="images/logo3.png" width="30" height="30" class="d-inline-block align-top" alt="果汁运营" />果汁运营</a>
            ...
            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6">
                <div class="col">
                    <a href="https://mp.weixin.qq.com/" target="_blank">
                        <img src="https://mp.weixin.qq.com/favicon.ico" class="ico">微信公众号</a></div>
                <div class="col">
                    <a href="https://mp.toutiao.com/" target="_blank">
                        <img src="https://www.toutiao.com/favicon.ico" class="ico">头条号</a></div>
                <div class="col">
                    <a href="https://baijiahao.baidu.com/" target="_blank">
                        <img src="https://baijiahao.baidu.com/favicon.ico" class="ico">百家号</a></div>
                <div class="col">
                    <a href="https://om.qq.com/" target="_blank">
                        <img src="https://om.qq.com/favicon.ico" class="ico">企鹅号</a></div>
                <div class="col">
                    <a href="https://mp.sohu.com/" target="_blank">
                        <img src="https://mp.sohu.com/favicon.ico" class="ico">搜狐号</a></div>
                <div class="col">
                    <a href="https://mp.163.com/" target="_blank">
                        <img src="https://mp.163.com/favicon.ico" class="ico">网易号</a></div>
                <div class="col">
                    <a href="https://creator.douyin.com/" target="_blank">
                        <img src="images/dy.png" class="ico">抖音创作平台</a></div>
                <div class="col">
                    <a href="https://cp.kuaishou.com/" target="_blank">
                        <img src="https://www.kuaishou.com/favicon.ico" class="ico">快手创作平台</a></div>
                <div class="col">
                    <a href="https://member.bilibili.com/" target="_blank">
                        <img src="https://www.bilibili.com/favicon.ico" class="ico">B站创作中心</a></div>
                <div class="col">
                    <a href="https://studio.ixigua.com/" target="_blank">
                        <img src="https://www.ixigua.com/favicon.ico" class="ico">西瓜视频创作平台</a></div>
                <div class="col">
                    <a href="https://channels.weixin.qq.com/" target="_blank">
                        <img src="images/sph.ico" class="ico">微信视频号助手</a></div>
                <div class="col">
                    <a href="https://www.xiaohongshu.com/explore" target="_blank">
                        <img src="https://www.xiaohongshu.com/favicon.ico" class="ico">小红书</a></div>
                <div class="col">
                    <a href="https://mp.dayu.com/" target="_blank" title="UC旗下自媒体平台" data-toggle="tooltip" data-placement="bottom" data-trigger="hover">
                        <img src="images/dayu.ico" class="ico">大鱼号</a></div>
                <div class="col">
                    <a href="https://zhuanlan.zhihu.com/" target="_blank">
                        <img src="https://www.zhihu.com/favicon.ico" class="ico">知乎专栏</a></div>
                <div class="col">
        ...
        <script type="text/javascript" src="css/jquery.anchorScroll.min.js"></script>
