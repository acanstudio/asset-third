...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/so-min.css?v3.1.1" />
    ...
    <body>
        <div class="mob">
            <div class="mobbc">
                <img src="images/logo.png" class="logo" alt="logo" /></div>
            <div class="search">
        ...
        <div class="top"></div>
        <div class="logos">
            <img src="images/logos.gif" title="输入关键词，点击搜索框下方按钮/回车即可搜索"></div>
        <div class="jumbotron">
            <div class="container">
            ...
            <div class="row row-cols-3 row-cols-sm-4 row-cols-md-6 row-cols-lg-6">
                ...
                <div class="col">
                    <a href="https://weibo.com/" target="_blank">
                        <img src="images/wb.png" class="ico">微博</a></div>
                <div class="col">
                    <a href="https://www.qq.com/" target="_blank">
                        <img src="images/tx.png" class="ico">腾讯网</a></div>
                <div class="col">
                    <a href="https://www.bilibili.com/" target="_blank">
                        <img src="images/bl.png" class="ico">哔哩哔哩</a></div>
                <div class="col">
                    <a href="https://www.kuaishou.com/" target="_blank">
                        <img src="images/ks.png" class="ico">快手</a></div>
                <div class="col">
                    <a href="https://www.douyin.com/" target="_blank">
                        <img src="images/dyy.png" class="ico">抖音</a></div>
                <div class="col">
                    <a href="https://www.huya.com/" target="_blank">
                        <img src="images/hy.png" class="ico">虎牙</a></div>
                <div class="col">
                    <a href="http://guozhivip.com/mvs.html" target="_blank">
                        <img src="images/ys.png" class="ico">观影追剧</a></div>
                <div class="col">
                    <a href="http://guozhivip.com/">
                        <img src="images/dh.png" class="ico">资源大全</a></div>
                <div class="col">
                    <a href="http://guozhivip.com/rank/" target="_blank">
                        <img src="images/rank.jpg" class="ico">热门排行榜</a></div>
                <div class="col">
                    <a href="http://guozhivip.com/tool/" target="_blank">
                        <img src="images/tool.png" class="ico">在线工具</a></div>
                <div class="col">
                    <a href="http://guozhivip.com/imgs.html" target="_blank">
                        <img src="images/bz.png" class="ico">壁纸美图</a></div>
                <div class="col">
                    <a href="http://guozhivip.com/design/" target="_blank">
                        <img src="images/des.png" class="ico">设计导航</a></div>
                <div class="col">
                    <a href="http://guozhivip.com/lab/" target="_blank">
                        <img src="images/lab.png" class="ico">有点意思</a></div>
            </div>
        </div>
        <footer>
            <div class="copyright">
        ...
        <script type='text/javascript' src="css/jquery-migrate-3.0.0.min.js"></script>
        <script type='text/javascript' charset="gbk" src="https://cdn.jsdelivr.net/opensug/1.1.1/opensug.js"></script>
