...
function searchresult(e){console.log('111');
	var _this=$(e);
	...
	window.history.pushState({},0,url);console.log('222');
	$.ajax({type:'get',url:thisurl,data:_this.data(),success:function(data){console.log('333');
		...
		var cssarr=$('.searchselect3').find('.pagecss').data('css'); console.log(cssarr);
		$('.searchselect3').find('.pagecss').remove();
		if(cssarr){
			var pagecssarr=$('.pagecss:first').data('css').split(',');
			cssarr=cssarr.split(',');
			for(var i in cssarr){
		...
		var jsarr=$('.searchselect3').find('.pagejs').data('js');
		$('.searchselect3').find('.pagejs').remove();
		if(jsarr){
			var pagejsarr=$('.pagejs:first').data('js').split(',');	
			jsarr=jsarr.split(',');
			for(var i in jsarr){
