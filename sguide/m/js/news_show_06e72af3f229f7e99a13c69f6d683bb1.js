...
/*/public/js/mobile/v2019/block/publicblock/articlecomment.js*/
$(function (){
...
function say(e){
	...
	$.ajax({type:'POST',url:'/ajaxstream/comment/',data:{'action':'say','blockid':blockid,'itid':itid,'yingyongid':yingyongid,'cont':contobj.html()},success:function(data){
		if(data.indexOf('error')!=-1){
			...
			dialog('温馨提醒',data.split('|')[1],function(){window.location.href='/user/truename/'},'立即前往');
		}else{
			...
			$('#commentinputbox .beforeinput').removeClass('forinput');
			contobj.empty();
		}
		$(e).attr('load','0');
...
/*/public/js/mobile/v2019/block/comment/commentlist.js*/
...
/*/public/js/mobile/v2019/block/publicblock/articlelist.js*/
