...
/*/public/js/mobile/v2019/block/brand10/brand10col1.js*/
$(document).ready(function(e) {
	var liheight=70,shownum=3;
	if($('.brand10col1 .zhishibang').length>0&&$('.brand10col1 .zhishibang').find('.item2').length>shownum){
		var maxheight1=$('.brand10col1 .zhishibang').find('.item2').length*liheight;
		setInterval(function(){
			var scrolltop=$('.brand10col1 .zhishibang').scrollTop()+liheight*shownum;
			scrolltop>=maxheight1?scrolltop=0:'';
			$('.brand10col1 .zhishibang').animate({scrollTop:scrolltop},{duration:300});
		},3000);
	}
	if($('.brand10col1 .quwenbang').length>0&&$('.brand10col1 .quwenbang').find('.item2').length>shownum){
		var maxheight2=$('.brand10col1 .quwenbang').find('.item2').length*liheight;
		setInterval(function(){
			var scrolltop=$('.brand10col1 .quwenbang').scrollTop()+liheight*shownum;
			scrolltop>=maxheight2?scrolltop=0:'';
			$('.brand10col1 .quwenbang').animate({scrollTop:scrolltop},{duration:300});
		},3000);
	}
	if($('.brand10col1 .shenghuobang').length>0&&$('.brand10col1 .shenghuobang').find('.item2').length>shownum){
		var maxheight3=$('.brand10col1 .shenghuobang').find('.item2').length*liheight;
		setInterval(function(){
			var scrolltop=$('.brand10col1 .shenghuobang').scrollTop()+liheight*shownum;
			scrolltop>=maxheight3?scrolltop=0:'';
			$('.brand10col1 .shenghuobang').animate({scrollTop:scrolltop},{duration:300});
		},3000);
	}
});